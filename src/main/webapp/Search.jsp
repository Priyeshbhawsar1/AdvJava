...
<body>
    ...
    <nav class="navbar navbar-dark bg-dark">
        <div class="container">
            ...
            <a href="Register.jsp" class="btn btn-outline-danger" role="button">Logout</a>
        </div>
    </nav>
            ...
            <div class="col-6 md-8 mt-5">
                ...
                <form action="Search" class="row g-3" method="post">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="inputFirstName4" name="firstName" placeholder="FirstName"
                            required>
                    </div>
                    <div class="col-md-6">
                        <label for="inputLastName4" class="form-label">Last Name</label>
                        <input type="text" class="form-control" id="inputLastName4" name="lastName" placeholder="LastName"
                            required>
                    </div>
